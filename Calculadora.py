...
calculadora_icone = PhotoImage(file='C:\\Users\\Joao Luiz\\Documents\\python_tkinter_codes\\calculadora.png')
window.iconphoto(True, calculadora_icone)
...
clear_button = Button(frame1, text='C', width=9, height=3, command=clear, bd=3, relief=RAISED, font=('Arial', 25, 'bold'))
clear_button.grid(row=4, column=0, columnspan=5)
